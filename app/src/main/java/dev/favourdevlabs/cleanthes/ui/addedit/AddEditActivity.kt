...
import dev.favourdevlabs.cleanthes.ui.theme.SurfaceDeep
...
private class ScanQrContract : ActivityResultContract<Unit, String?>() {
    ...
    override fun parseResult(
        resultCode: Int,
        intent: Intent?,
    ): String? = IntentIntegrator.parseActivityResult(resultCode, intent)?.contents
}
...
private fun AddEditScreen(
    ...
    val scanLauncher =
        rememberLauncherForActivityResult(ScanQrContract()) { contents ->
...
@Composable
private fun cleanthesOutlinedTextFieldColors() =
