...
class InitialiseCitadelImpl @Inject constructor(
    @ApplicationContext private val context: Context,
    private val filenameProvider: CitadelFilenameProvider,
) : InitialiseCitadel {

    override suspend fun invoke(masterPassword: String, profile: CitadelProfile): InitialiseCitadel.Result =
        withContext(Dispatchers.IO) {
            ...
            val citadelKey    = KeyDerivation.generateCitadelKey()
            val pwdDerivedKey = KeyDerivation.deriveKey(masterPassword.toCharArray(), encSaltBytes)
            val wrappedCitadelKeyPassword = KeyDerivation.wrapKey(citadelKey, pwdDerivedKey)
            ...
            EncryptedSharedPreferences.create(
                ...
                .putBoolean(KEY_CITADEL_EXISTS, true)
                ...
                .putString(KEY_WRAPPED_CITADEL_KEY_PASSWORD, wrappedCitadelKeyPassword)
                .apply()

            InitialiseCitadel.Result(
                citadelKey                = citadelKey,
                encSalt                   = encSalt,
                wrappedCitadelKeyPassword = wrappedCitadelKeyPassword,
